(module
  ...
  (func (export "run") (param $inputPtr i32) (param $outputPtr i32) (param $pixelCount i32)
    ...
    (local.set $vScale (f32x4.splat (f32.const 131071.0)))
    ...
    (block $simd_exit
      (loop $simd_loop
        ...
        (local.set $vR (f32x4.replace_lane 3 (f32x4.replace_lane 2 (f32x4.replace_lane 1
            (f32x4.splat (f32.load (i32.shl (i32.load16_u (local.get $inPos)) (i32.const 2))))
            (f32.load (i32.shl (i32.load16_u offset=6 (local.get $inPos)) (i32.const 2))))
            (f32.load (i32.shl (i32.load16_u offset=12 (local.get $inPos)) (i32.const 2))))
            (f32.load (i32.shl (i32.load16_u offset=18 (local.get $inPos)) (i32.const 2)))))
        (local.set $vG (f32x4.replace_lane 3 (f32x4.replace_lane 2 (f32x4.replace_lane 1
            (f32x4.splat (f32.load (i32.shl (i32.load16_u offset=2 (local.get $inPos)) (i32.const 2))))
            (f32.load (i32.shl (i32.load16_u offset=8 (local.get $inPos)) (i32.const 2))))
            (f32.load (i32.shl (i32.load16_u offset=14 (local.get $inPos)) (i32.const 2))))
            (f32.load (i32.shl (i32.load16_u offset=20 (local.get $inPos)) (i32.const 2)))))
        (local.set $vB (f32x4.replace_lane 3 (f32x4.replace_lane 2 (f32x4.replace_lane 1
            (f32x4.splat (f32.load (i32.shl (i32.load16_u offset=4 (local.get $inPos)) (i32.const 2))))
            (f32.load (i32.shl (i32.load16_u offset=10 (local.get $inPos)) (i32.const 2))))
            (f32.load (i32.shl (i32.load16_u offset=16 (local.get $inPos)) (i32.const 2))))
            (f32.load (i32.shl (i32.load16_u offset=22 (local.get $inPos)) (i32.const 2)))))
        (local.set $inPos (i32.add (local.get $inPos) (i32.const 24)))
        ...
        (local.set $vRo (i32x4.trunc_sat_f32x4_u (f32x4.add (f32x4.mul (f32x4.sqrt (f32x4.sqrt (f32x4.min (f32x4.max (local.get $vRo) (local.get $vZero)) (local.get $vOne)))) (local.get $vScale)) (local.get $vHalf))))
        (local.set $vGo (i32x4.trunc_sat_f32x4_u (f32x4.add (f32x4.mul (f32x4.sqrt (f32x4.sqrt (f32x4.min (f32x4.max (local.get $vGo) (local.get $vZero)) (local.get $vOne)))) (local.get $vScale)) (local.get $vHalf))))
        (local.set $vBo (i32x4.trunc_sat_f32x4_u (f32x4.add (f32x4.mul (f32x4.sqrt (f32x4.sqrt (f32x4.min (f32x4.max (local.get $vBo) (local.get $vZero)) (local.get $vOne)))) (local.get $vScale)) (local.get $vHalf))))
        ...
        (i32.store16 offset=6 (local.get $outPos) (i32.load16_u (i32.add (i32.const 262144) (i32.shl (local.get $ti) (i32.const 1)))))
        (local.set $ti (i32x4.extract_lane 1 (local.get $vGo)))
        (i32.store16 offset=8 (local.get $outPos) (i32.load16_u (i32.add (i32.const 262144) (i32.shl (local.get $ti) (i32.const 1)))))
        (local.set $ti (i32x4.extract_lane 1 (local.get $vBo)))
        (i32.store16 offset=10 (local.get $outPos) (i32.load16_u (i32.add (i32.const 262144) (i32.shl (local.get $ti) (i32.const 1)))))
        (local.set $ti (i32x4.extract_lane 2 (local.get $vRo)))
        (i32.store16 offset=12 (local.get $outPos) (i32.load16_u (i32.add (i32.const 262144) (i32.shl (local.get $ti) (i32.const 1)))))
        (local.set $ti (i32x4.extract_lane 2 (local.get $vGo)))
        (i32.store16 offset=14 (local.get $outPos) (i32.load16_u (i32.add (i32.const 262144) (i32.shl (local.get $ti) (i32.const 1)))))
        (local.set $ti (i32x4.extract_lane 2 (local.get $vBo)))
        (i32.store16 offset=16 (local.get $outPos) (i32.load16_u (i32.add (i32.const 262144) (i32.shl (local.get $ti) (i32.const 1)))))
        (local.set $ti (i32x4.extract_lane 3 (local.get $vRo)))
        (i32.store16 offset=18 (local.get $outPos) (i32.load16_u (i32.add (i32.const 262144) (i32.shl (local.get $ti) (i32.const 1)))))
        (local.set $ti (i32x4.extract_lane 3 (local.get $vGo)))
        (i32.store16 offset=20 (local.get $outPos) (i32.load16_u (i32.add (i32.const 262144) (i32.shl (local.get $ti) (i32.const 1)))))
        (local.set $ti (i32x4.extract_lane 3 (local.get $vBo)))
        (i32.store16 offset=22 (local.get $outPos) (i32.load16_u (i32.add (i32.const 262144) (i32.shl (local.get $ti) (i32.const 1)))))
        (local.set $outPos (i32.add (local.get $outPos) (i32.const 24)))
    ...
    (block $simd_exit
      (loop $simd_loop
        ...
        (local.set $vR (f32x4.replace_lane 3 (f32x4.replace_lane 2 (f32x4.replace_lane 1
            ...
            (f32.load (i32.shl (i32.load16_u offset=8 (local.get $inPos)) (i32.const 2))))
            (f32.load (i32.shl (i32.load16_u offset=16 (local.get $inPos)) (i32.const 2))))
            (f32.load (i32.shl (i32.load16_u offset=24 (local.get $inPos)) (i32.const 2)))))
        (local.set $vG (f32x4.replace_lane 3 (f32x4.replace_lane 2 (f32x4.replace_lane 1
            (f32x4.splat (f32.load (i32.shl (i32.load16_u offset=2 (local.get $inPos)) (i32.const 2))))
            (f32.load (i32.shl (i32.load16_u offset=10 (local.get $inPos)) (i32.const 2))))
            (f32.load (i32.shl (i32.load16_u offset=18 (local.get $inPos)) (i32.const 2))))
            (f32.load (i32.shl (i32.load16_u offset=26 (local.get $inPos)) (i32.const 2)))))
        (local.set $vB (f32x4.replace_lane 3 (f32x4.replace_lane 2 (f32x4.replace_lane 1
            (f32x4.splat (f32.load (i32.shl (i32.load16_u offset=4 (local.get $inPos)) (i32.const 2))))
            (f32.load (i32.shl (i32.load16_u offset=12 (local.get $inPos)) (i32.const 2))))
            (f32.load (i32.shl (i32.load16_u offset=20 (local.get $inPos)) (i32.const 2))))
            (f32.load (i32.shl (i32.load16_u offset=28 (local.get $inPos)) (i32.const 2)))))
        (local.set $inPos (i32.add (local.get $inPos) (i32.const 32)))
        (local.set $vRo (f32x4.add (f32x4.add (f32x4.mul (local.get $vR) (local.get $cm00)) (f32x4.mul (local.get $vG) (local.get $cm01))) (f32x4.mul (local.get $vB) (local.get $cm02))))
        (local.set $vGo (f32x4.add (f32x4.add (f32x4.mul (local.get $vR) (local.get $cm10)) (f32x4.mul (local.get $vG) (local.get $cm11))) (f32x4.mul (local.get $vB) (local.get $cm12))))
        (local.set $vBo (f32x4.add (f32x4.add (f32x4.mul (local.get $vR) (local.get $cm20)) (f32x4.mul (local.get $vG) (local.get $cm21))) (f32x4.mul (local.get $vB) (local.get $cm22))))
        (local.set $vRo (i32x4.trunc_sat_f32x4_u (f32x4.add (f32x4.mul (f32x4.sqrt (f32x4.sqrt (f32x4.min (f32x4.max (local.get $vRo) (local.get $vZero)) (local.get $vOne)))) (local.get $vScale)) (local.get $vHalf))))
  ...
  (func (export "run_a_out") (param $inputPtr i32) (param $outputPtr i32) (param $pixelCount i32)
    ...
    (block $simd_exit
      (loop $simd_loop
        ...
        (i32.store16 offset=14 (local.get $outPos) (i32.const 65535))
        (i32.store16 offset=22 (local.get $outPos) (i32.const 65535))
        (i32.store16 offset=30 (local.get $outPos) (i32.const 65535))
        (local.set $inPos (i32.add (local.get $inPos) (i32.const 24)))
        (local.set $vRo (f32x4.add (f32x4.add (f32x4.mul (local.get $vR) (local.get $cm00)) (f32x4.mul (local.get $vG) (local.get $cm01))) (f32x4.mul (local.get $vB) (local.get $cm02))))
        (local.set $vGo (f32x4.add (f32x4.add (f32x4.mul (local.get $vR) (local.get $cm10)) (f32x4.mul (local.get $vG) (local.get $cm11))) (f32x4.mul (local.get $vB) (local.get $cm12))))
        (local.set $vBo (f32x4.add (f32x4.add (f32x4.mul (local.get $vR) (local.get $cm20)) (f32x4.mul (local.get $vG) (local.get $cm21))) (f32x4.mul (local.get $vB) (local.get $cm22))))
        ...
        (i32.store16 offset=20 (local.get $outPos) (i32.load16_u (i32.add (i32.const 262144) (i32.shl (local.get $ti) (i32.const 1)))))
        (local.set $ti (i32x4.extract_lane 3 (local.get $vRo)))
        (i32.store16 offset=24 (local.get $outPos) (i32.load16_u (i32.add (i32.const 262144) (i32.shl (local.get $ti) (i32.const 1)))))
        (local.set $ti (i32x4.extract_lane 3 (local.get $vGo)))
        (i32.store16 offset=26 (local.get $outPos) (i32.load16_u (i32.add (i32.const 262144) (i32.shl (local.get $ti) (i32.const 1)))))
        (local.set $ti (i32x4.extract_lane 3 (local.get $vBo)))
        (i32.store16 offset=28 (local.get $outPos) (i32.load16_u (i32.add (i32.const 262144) (i32.shl (local.get $ti) (i32.const 1)))))
        (local.set $outPos (i32.add (local.get $outPos) (i32.const 32)))
        (local.set $p      (i32.add (local.get $p)      (i32.const 4)))
        (br $simd_loop)))
  ...
  (func (export "run_a_copy") (param $inputPtr i32) (param $outputPtr i32) (param $pixelCount i32)
    ...
    (block $simd_exit
      (loop $simd_loop
        ...
        (i32.store16 offset=14 (local.get $outPos) (i32.load16_u offset=14 (local.get $inPos)))
        (i32.store16 offset=22 (local.get $outPos) (i32.load16_u offset=22 (local.get $inPos)))
        (i32.store16 offset=30 (local.get $outPos) (i32.load16_u offset=30 (local.get $inPos)))
        (local.set $inPos (i32.add (local.get $inPos) (i32.const 32)))
        (local.set $vRo (f32x4.add (f32x4.add (f32x4.mul (local.get $vR) (local.get $cm00)) (f32x4.mul (local.get $vG) (local.get $cm01))) (f32x4.mul (local.get $vB) (local.get $cm02))))
        (local.set $vGo (f32x4.add (f32x4.add (f32x4.mul (local.get $vR) (local.get $cm10)) (f32x4.mul (local.get $vG) (local.get $cm11))) (f32x4.mul (local.get $vB) (local.get $cm12))))
        (local.set $vBo (f32x4.add (f32x4.add (f32x4.mul (local.get $vR) (local.get $cm20)) (f32x4.mul (local.get $vG) (local.get $cm21))) (f32x4.mul (local.get $vB) (local.get $cm22))))
