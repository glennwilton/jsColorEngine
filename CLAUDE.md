...
- **Never "clean up" the unrolled kernel loops** (`src/Transform.js`
  hot paths, `src/kernels/`) — read the PERFORMANCE LESSONS comment
  block at the top of `src/Transform.js` before touching them, and
  benchmark before/after any change.
