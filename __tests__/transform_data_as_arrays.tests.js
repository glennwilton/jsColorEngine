...
test('sRGB+Alpha to CMYK via arrays ', async () => {
    let cmykProfile = new Profile();
    await cmykProfile.loadPromise('file:' + cmykFilename)
...
test('sRGB+Alpha to CMYK+Alpha via arrays ', async () => {
    let cmykProfile = new Profile();
    await cmykProfile.loadPromise('file:' + cmykFilename)
...
test('sRGB+Alpha to CMYK+Alpha via arrays with PRESERVE Alpha ', async () => {
    let cmykProfile = new Profile();
    await cmykProfile.loadPromise('file:' + cmykFilename)
...
test('sRGB+Alpha to CMYK+Alpha via arrays with PRESERVE Alpha with length of 3', async () => {
    let cmykProfile = new Profile();
    await cmykProfile.loadPromise('file:' + cmykFilename)
...
test('sRGB+Alpha to CMYK+Alpha via arrays with PRESERVE Alpha with length of 3 as Uint8ClampedArray', async () => {
    let cmykProfile = new Profile();
    await cmykProfile.loadPromise('file:' + cmykFilename)
